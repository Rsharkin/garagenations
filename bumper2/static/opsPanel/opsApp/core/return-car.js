...
function ReturnCarModalInstanceCtrl($uibModalInstance, BookingService, booking, CommonService) {
    ...
    function scheduleDrop(){
        ...
        var actionToSet = 18; // drop schedule pending
        ...
        var data = {'return_reason': self.selectedReasonForReturn && self.selectedReasonForReturn.id != '?' ? self.selectedReasonForReturn.id:''};
