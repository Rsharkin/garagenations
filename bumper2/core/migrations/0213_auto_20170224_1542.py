...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='send_notice_to',
            field=models.SmallIntegerField(default=2, choices=[(1, b'Customer'), (2, b'Ops'), (3, b'Pickup Driver'), (4, b'Drop Driver'), (5, b'Workshop Executive')]),
        ),
        ...
        migrations.AlterField(
            model_name='notifications',
            name='name',
            field=models.CharField(help_text=b'Do not change this, this is used in code. Eg. TempName1', max_length=64),
        ),
    ]
