...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='messages',
            name='label',
            field=models.PositiveSmallIntegerField(help_text=b'This is to identify which screen will open in UI', null=True, choices=[(1, b'Status'), (2, b'Feedback'), (3, b'Update'), (4, b'Offer'), (5, b'Referral'), (6, b'RateUs'), (7, b'FillProfile'), (8, b'FillCarInfo')]),
        ),
        migrations.AlterField(
            model_name='notifications',
            name='push_level',
            field=models.SmallIntegerField(default=1, null=True, blank=True, choices=[(1, b'Status'), (2, b'Feedback'), (3, b'Update'), (4, b'Offer'), (5, b'Referral'), (6, b'RateUs'), (7, b'FillProfile'), (8, b'FillCarInfo')]),
        ),
    ]
